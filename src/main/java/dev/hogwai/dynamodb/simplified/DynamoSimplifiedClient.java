...
public class DynamoSimplifiedClient implements DynamoSimplifiedClientInterface {
     ...
     * filtering.
     * <p>
     * The entity class must be annotated with {@link dev.hogwai.dynamodb.simplified.entity.Entity @Entity}.
     * Key components are defined via {@link dev.hogwai.dynamodb.simplified.entity.KeyComponent @KeyComponent}
